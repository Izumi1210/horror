...
public class InvaderTimeController : MonoBehaviour
{
    ...
    {
        StartCoroutine(InvaderTimerCoroutine());
    }


    IEnumerator InvaderTimerCoroutine()
    {
        gameTimeLimit = InvaderGameController.instance.timeLimit;
        ...
        InvaderGameController.instance.GameOver();
    }
}
